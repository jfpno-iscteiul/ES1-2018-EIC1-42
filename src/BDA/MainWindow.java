...
public class MainWindow {
	...
	private void initialize() {
		...
		Image imagem1 = new ImageIcon(this.getClass().getResource("/Imagens/iscte_wm.png")).getImage();
		...
		Image signUp = new ImageIcon(this.getClass().getResource("/Imagens/button_sign-up.png")).getImage();
		...
		Image icon = new ImageIcon(this.getClass().getResource("/Imagens/logof.png")).getImage();
		...
		Image logInImage = new ImageIcon(this.getClass().getResource("/Imagens/button_login.png")).getImage();
