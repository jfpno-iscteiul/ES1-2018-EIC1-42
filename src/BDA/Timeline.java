...
public class Timeline {
	...
	void initialize() {
		...
		if (gestor.isOnline()) {
			...
			if (xml.haveTwitter(Email)) {
				Image icone11 = new ImageIcon(this.getClass().getResource("/Imagens/twitterm.png")).getImage();
			...
			if (xml.haveFacebook(Email)) {
				Image icone2 = new ImageIcon(this.getClass().getResource("/Imagens/facebookm.png")).getImage();
			...
			if (xml.haveEmail(Email)) {
				Image icone4 = new ImageIcon(this.getClass().getResource("/Imagens/emailm.png")).getImage();
